...
public class HohmannTransferProcedure extends DeltaVProcedure
{
    ...
    {
        return "Transfer from " + origin + " to " + destination + " with a max delta V of " + maxDeltaV + " and a rough travel time of " + ConversionHelper.secondToDay(roughTravelTime) + " days";
    }
    ...
    public void setOrigin(Celestial origin)
    {
        this.origin = origin;
    }

    public void setDestination(Celestial destination)
    {
        this.destination = destination;
    }
    ...
    public Celestial getDestination()
    {
        return destination;
    }

    public void setRoughTime(double v)
    {
        this.roughTravelTime = v;
    }

    public double getRoughTime()
    {
        return roughTravelTime;
    }
}